...
import {addHotDeal,getHotDeal,removingProducts,singleproduct,update}  from "../controllers/Hotdealcontroller.js";
...
hotdealsroutes.put("/update/:id",upload.fields ([{name:"image1",maxCount:1},{name:"image2",maxCount:1},{name:"image3",maxCount:1},{name:"image4",maxCount:1}]),update)
